...
import com.example.batterymanager.R.layout
...
class BatteryUsageAdapter(
    ...
    private val totalTime:Long) : RecyclerView.Adapter<BatteryUsageAdapter.ViewHolder>() {
  ...
  private var batteryFinalList:MutableList<BatteryModel> = ArrayList()
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BatteryUsageAdapter.ViewHolder {
