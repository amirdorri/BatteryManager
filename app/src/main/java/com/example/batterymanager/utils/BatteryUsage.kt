...
class BatteryUsage(context: Context) {
    ...
    fun getUsageStatusList(): List<UsageStats> {

        val usm = getUsageStatusManager(myContext)
    ...
    fun getTotalTime():Long{
        ...
        for (item in getUsageStatusList()){
    ...
    private fun getUsageStatusManager(context: Context): UsageStatsManager {
